...
const INTENT_CATEGORIES = {
  task_action: {
    patterns: [
      ...
      'ذكّرني','مزاجي','مزاج','سجّل','سجل','طاقتي','طاقة','اكمل','أكمل','كمل','احذف مهمة','عدّل','عدل',
      // Completion patterns (past tense)
      'اكتملت','أنجزت','انجزت','تمت','أتممت','كملت','خلصت مهمة','أنهيت','انهيت'
    ],
    label: 'task_action'
  },
  question: {
